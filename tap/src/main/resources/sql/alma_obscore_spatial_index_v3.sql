...
VALUES ('ASA_SCIENCE_A','SPATIAL_BOUNDS', MDSYS.SDO_DIM_ARRAY(SDO_DIM_ELEMENT('RA', 0, 360, 0.05), SDO_DIM_ELEMENT('DEC', -90, 90, 0.05)), 8307);

-- Necessary to prepare Oracle for the Spatial Index coming.
INSERT INTO USER_SDO_GEOM_METADATA
VALUES ('ASA_SCIENCE_B','SPATIAL_BOUNDS', MDSYS.SDO_DIM_ARRAY(SDO_DIM_ELEMENT('RA', 0, 360, 0.05), SDO_DIM_ELEMENT('DEC', -90, 90, 0.05)), 8307);
