...
package org.opencadc.conesearch.ws;
...
/**
 * Handle the availability endpoint and provide a status.
 */
public class ServiceAvailability implements AvailabilityPlugin {
    ...
    public Availability getStatus() {
        ...
        try {
            ...
            final URL tapBaseURL = coneSearchConfig.getTapBaseURL();
            final URL availURL = new URL(tapBaseURL.toExternalForm() + "/availability");
            final CheckWebService checkWebService = new CheckWebService(availURL);
