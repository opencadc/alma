...
package org.opencadc.datalink.ws;

import org.opencadc.datalink.DataLinkQueryRunner;
...
public class DataLinkJobManager extends SimpleJobManager {
    ...
    public DataLinkJobManager() {
        super();

        // Persist UWS jobs to memory by default.
        final MemoryJobPersistence jobPersist = new MemoryJobPersistence();
        final JobExecutor jobExec = new SyncJobExecutor(jobPersist, DataLinkQueryRunner.class);
