...
public class CannedQueryTest {
    ...
    public void testApplicationsLookup() {
        try {
            ...
            Assert.assertEquals("/reg/applications", returnedAppUrl.getPath());

            // Check something is returned from the service
            // - means reg-applications.properties file is in the correct place on the server
            ByteArrayOutputStream bos = new ByteArrayOutputStream();
            HttpDownload get = new HttpDownload(returnedAppUrl, bos);
            get.run();
